...
, 1683.038432, 3350.572205, 6738.948528, 215255.7737, 430939.6048, 820895.17716
    ...
    # == C_list
    print(f'rc\tkappa\tKmax\ttime\tereal\tereci\teself\tetotal')
    for rc in range(2, 14, 2):
        for kappa in range(10):
            ...
            for Kmax in range(5, 300, 5):                
                ...
                etotal = ereal+eself+ereci
                print(f'{rc}\t{kappa}\t{Kmax}\t{end-start}\t{ereal}\t{ereci}\t{eself}\t{etotal}')
